...
export default function MedicalList() {
  return (
    <Card className="md:col-start-4 md:col-end-6 bg-white shadow-xl  justify-self-center md:mx-2">
      <h2 className="secondHeaders text-slate-900 text-center md:text-xl py-3 md:py-0 md:px-2 md:text-left">
        Historial Médico
      </h2>
